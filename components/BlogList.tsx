            ...
            {posts.map(post => (
                ...
                <div  className="flex flex-col group cursor-pointer">
                    ...
                    <div className="mt-5 flex-1 ">
                        <p className="dark:text-white text-black underline text-lg font-bold ">{post.title}</p>
                        <p className="text-gray-500 line-clamp-2">{post.description}</p>
                    </div>
                    <p className="dark:text-white text-black mt-5 font-bold flex items-center group-hover:underline">
                        Read
